...
// Corrected UUID search (no lower(uuid) errors)
...
export default async function MtgCardPricesPage({
  ...
  return (
    <section className="space-y-6">
      ...
      {/* ----------------------------------------------------
          PRICECHARTING — Per-Card Snapshot (DB)
      ------------------------------------------------------ */}
        ...
        {pc ? (
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm">
            <div className="rounded-md bg-white/5 border border-white/10 p-3">
              <div className="text-white/60 text-xs">Loose (Ungraded)</div>
            ...
            <div className="rounded-md bg-white/5 border border-white/10 p-3">
              <div className="text-white/60 text-xs">Graded 9</div>
              <div className="text-white font-semibold">
            ...
            <div className="rounded-md bg-white/5 border border-white/10 p-3">
              <div className="text-white/60 text-xs">PSA 10</div>
              <div className="text-white font-semibold">
            ...
            <div className="rounded-md bg-white/5 border border-white/10 p-3">
              <div className="text-white/60 text-xs">CGC 10</div>
              <div className="text-white font-semibold">
            ...
            <div className="rounded-md bg-white/5 border border-white/10 p-3">
              <div className="text-white/60 text-xs">SGC 10</div>
              <div className="text-white font-semibold">
            ...
            <div className="rounded-md bg-white/5 border border-white/10 p-3">
              <div className="text-white/60 text-xs">Snapshot</div>
      ...
      {/* ----------------------------------------------------
          PRICECHARTING — TOP MTG (CSV Snapshot)
      ------------------------------------------------------ */}
      <div className="rounded-xl border border-white/15 bg-white/5 p-5 text-white/90">
      ...
      <div className="rounded-xl border border-white/15 bg-white/5 p-5 text-white/90">
        ...
        {noHistoryOrValues ? (
          <div className="rounded-md border border-white/10 bg-white/5 p-3 text-sm text-white/80">
            Not enough history yet. Snapshots will populate after your
            daily scryfall run.
          </div>
        ) : (
